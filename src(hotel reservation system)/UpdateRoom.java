	...
	public UpdateRoom() throws SQLException {
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                                ...
                                while(rs1.next()){
                                    txt_Room.setText(rs1.getString("foom"));    
                                }
                            }catch(Exception ee){}
                            try{
                                conn c  = new conn();
                                ResultSet rs2 = c.statement.executeQuery("select * from Room where room = "+txt_Room.getText());
                                while(rs2.next()){
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) throws NumberFormatException {
				...
				try{
                                    conn c = new conn();
                                    String str = "update Room set status = '"+txt_Status.getText()+"' where room = "+txt_Room.getText();
