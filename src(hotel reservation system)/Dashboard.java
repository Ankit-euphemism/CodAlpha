...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons\\cq5dam.web.756.756.jpeg"));
	...
	AirlineManagementSystem.setForeground(Color.black);
        AirlineManagementSystem.setFont(new Font("serif", Font.PLAIN, 40));
	AirlineManagementSystem.setBounds(300, 50, 1000, 50);
	NewLabel.add(AirlineManagementSystem);
		
        JMenuBar menuBar = new JMenuBar();
	setJMenuBar(menuBar);
		
        JMenu AirlineSystem = new JMenu("HOTEL RESERVATION SYSTEM");
