...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
		...
		contentPane.add(lblReserveRoomNumber);
                ...
                try{
                    conn c01 = new conn();
                    ResultSet rs = ((java.sql.Statement)c01.statement).executeQuery("select * from Room where available='Available'");
                    while(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String checkintime =  t5.getText();
                                ...
                                String q1 = "insert into ct values('"+document+"','"+number+"','"+name+"','"+gender+"','"+country+"','"+room+"','"+checkintime+"','"+deposite+"')";
                                String q2 = "update Room set available = 'Occupied'";
                                ((java.sql.Statement)c.statement).executeUpdate(q1);
                                ((java.sql.Statement)c.statement).executeUpdate(q2);
