...
public class Checkout extends JFrame{
	...
	public Checkout() throws SQLException {
		...
		contentPane.add(c1);
                ...
                ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons\\night.jpg"));
                ...
                l2.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent ae){
                        ...
                        try{
                            ...
                            ResultSet rs = c.statement.executeQuery("select * from ct where number = "+number);
                            
                            if(rs.next()){
                                System.out.println("clicked");
                                t1.setText(rs.getString("foom"));    
                            }
                        }catch(Exception e){ }
                    }
                });
		...
		btnCheckOut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String deleteSQL = "Delete from ct where number = "+id;
                                String q2 = "update Room set available = 'Available' where room = "+s1;
	    		...
	    		try{
	    			...
	    			c.statement.executeUpdate(deleteSQL);
