...
public class HotelReservationSystem extends JFrame implements ActionListener{
        ...
        public HotelReservationSystem() {
                ...
                setSize(1400,530); // setContentPane(300,300,1366,390);   frame size
                setLayout(null);
                setLocation(0,20);
                ...
                Image i3 = i1.getImage().getScaledInstance(1400, 530,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                l1 = new JLabel(i2);
                JLabel lid=new JLabel("HOTEL RESERVATION SYSTEM");
                lid.setBounds(0,0,1400,50);
